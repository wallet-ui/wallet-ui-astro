...
<PackageManagerTabs
	npm={`npm create vite@latest my-vite-app -- --template react-ts
cd my-vite-app`}
	pnpm={`pnpm dlx create-vite@latest my-vite-app --template react-ts
cd my-vite-app`}
	bun={`bunx create-vite@latest my-vite-app --template react-ts
cd my-vite-app`}
/>
...
<PackageManagerTabs
	npm="npm install @wallet-ui/react @wallet-ui/tailwind"
	pnpm="pnpm add @wallet-ui/react @wallet-ui/tailwind"
	bun="bun add @wallet-ui/react @wallet-ui/tailwind"
/>
