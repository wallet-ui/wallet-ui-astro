...
This hook powers the standard [`WalletUiDropdown`](/react/components/dropdown/) component. You can use this hook directly to build a completely custom dropdown UI.
