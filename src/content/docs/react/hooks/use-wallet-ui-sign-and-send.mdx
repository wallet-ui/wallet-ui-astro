...
<Callout>
    ...
    [`useWalletUiSigner`](/react/hooks/use-wallet-ui-signer/) hook.
</Callout>
...
<Callout type="note" title="Interactive demo pending">
	The runnable demo for this hook has not been ported yet. Use the example above for now and track the
	follow-up in [issue #10](https://github.com/wallet-ui/wallet-ui-astro/issues/10).
</Callout>
