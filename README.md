...
- it keeps the current temporary Workers URL and noindex posture intact
...
4. Confirm the deployed Worker is reachable at `https://wallet-ui-astro.wallet-ui.workers.dev`.
